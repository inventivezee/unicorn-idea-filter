...
Score startup ideas against a unicorn/IPO bar **before** committing years to one. Ten hard pass/fail gates, fifteen weighted criteria (0–5 with scoring anchors), a confidence multiplier, and a decision engine that tells you: **BUILD / INCUBATE**, **VALIDATE FAST**, **PARK / NARROW**, or **KILL**.
...
- **AI analysis** — one click fills the whole scorecard from your idea + founder background (Anthropic Claude or OpenAI models, selectable in Settings). Founder-personal gates (10-year commitment, unfair advantages) are flagged for manual confirmation, never silently auto-answered.
...
gateStatus = FAIL if any gate is N · PENDING if any unanswered · PASS if all 10 Y
